...
// Default stops are a monochrome white / gray / black ramp (no rainbow hues).
...
// Floor (0) → top (1): near-black / charcoal → mid grays → soft white → transparent.
const GRAYSCALE_STOPS: Stop[] = [
  { offset: 0, color: "#0A0A0A" },
  { offset: 0.18, color: "#3A3A3A" },
  { offset: 0.36, color: "#6B6B6B" },
  { offset: 0.54, color: "#B3B3B3" },
  { offset: 0.7, color: "#E8E8E8" },
  { offset: 0.84, color: "#FFFFFF" },
...
export interface RuixenGradientFooterProps {
   ...
   * along the bottom edge before the scroll reveal starts. `0` keeps
